...
design principles. Alongside this, I am developing my
foundation in **Java programming**, strengthening my
understanding of object-oriented programming, system logic,
and application structure.

By combining **design awareness** with **technical knowledge**,
I aim to create digital experiences that are not only
...
![User Flow](https://img.shields.io/badge/User%20Flow%20Design-FF6B6B?style=for-the-badge&logo=diagrams.net&logoColor=white)
...
structure, and visual clarity in mind.*

This project showcases my ability to translate design
